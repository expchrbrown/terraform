...
var (
	...
	// since this is referenceable, though not directly, we need to ensure it
	// can be skipped when not targeted as well.
	_ RemovableIfNotTargeted = (*NodeDestroyResource)(nil)
)
...
func (n *NodeDestroyResource) RemoveIfNotTargeted() bool {
	return true
}
